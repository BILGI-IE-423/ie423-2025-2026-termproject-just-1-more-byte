...
- Jumana Asim Bakri Osman - 122203002
...
The dataset shows significant **class imbalance**. Type INFP is the most common (~1,832 users), while ESTJ is the rarest (~39 users). This imbalance is a known characteristic of this dataset and must be addressed in modeling (e.g., via class weighting or resampling).
